SampleApp ![Mean Stack Build Status](https://travis-ci.org/jpotts18/mean-stack-relational.png)
=====================
...
1. Clone the repository ```git clone git@github.com:krgautam/demoApp.git```.
1. Go into the repository ```cd demoApp/```.
